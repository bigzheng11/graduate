<template>
   <div class="container">
      ...
      <!-- 用户信息 -->
      <div class="userDetail" style="margin:10px;padding: 6px;">
         <!-- <div class="userPic"> -->
         <img
         ...
         />
         <!-- </div> -->
         <span style="vertical-align: top;position:relative;left:40px;top:10px"
            ><strong>{{ goodsDetail.user.userName }}</strong></span
         >
         <span style="position:relative;left:-60px;top:-10px">
