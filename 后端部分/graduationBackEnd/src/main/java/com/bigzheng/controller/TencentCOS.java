...
public class TencentCOS {
    // 此处填写的存储桶名称
    private static final String bucketName = "testdemo01-1307738235";
    // secretId
    private static final String secretId = "AKIDHRjrnW1JagXKuFLJ4KO8evxm6GArKZbQ";
    // secretKey
    private static final String secretKey = "d092KTO4VpxraAbpwrcBWIRQBkBR1NVX";
